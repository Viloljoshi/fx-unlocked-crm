        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5"><Label>Deal Types</Label><Input value={form.deal_types} onChange={e => setForm(f=>({...f,deal_types:e.target.value}))} placeholder="CPA, PNL, HYBRID" /></div>
            </div>
